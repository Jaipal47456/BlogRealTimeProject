...
#send_mail('Hello', 'Very imp msg....','jaij47456@gmail.com',['jail47456@gmail.com','jaij47456@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'jaij47456@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
        form = EmailSendForm()
